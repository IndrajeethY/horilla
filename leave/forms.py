...
class LeaveTypeAdminForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if f := self.fields.get("company_id"):
            from kite_widgets.forms import default_select_option_template
...
class LeaveOneAssignForm(KiteModelForm):
    """
    ...
    Attributes:
        - employee_id: A KiteMultiSelectField representing the employee to assign leave to.
    """
