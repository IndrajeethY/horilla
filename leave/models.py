...
class AvailableLeave(KiteModel):
...
class LeaverequestComment(KiteModel):
    """
...
class LeaveAllocationRequest(KiteModel):
    leave_type_id = models.ForeignKey(
        LeaveType, on_delete=models.PROTECT, verbose_name=_("Leave type")
    )
    employee_id = models.ForeignKey(
...
class LeaveallocationrequestComment(KiteModel):
    """
...
if apps.is_installed("attendance"):
    ...
    class CompensatoryLeaveRequest(KiteModel):
        leave_type_id = models.ForeignKey(
...
class LeaveGeneralSetting(KiteModel):
    """
...
if apps.is_installed("attendance"):
    ...
    class CompensatoryLeaverequestComment(KiteModel):
        """
...
class EmployeePastLeaveRestrict(KiteModel):
...
if apps.is_installed("attendance"):
    ...
    class OverrideLeaveRequests(LeaveRequest):
        ...
        #     """
        #     WorkRecords = get_kite_model_class(
