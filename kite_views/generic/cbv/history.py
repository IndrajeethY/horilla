...
from kite_views.cbv_methods import hx_request_required
from kite_views.generic.cbv.views import KiteFormView
from kite_views.history_methods import get_diff


@method_decorator(hx_request_required, name="dispatch")
class KiteHistoryView(DetailView):
    """
