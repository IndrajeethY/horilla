...
from kite_views import views
from kite_views.generic.cbv import history
from kite_views.generic.cbv.views import ReloadMessages
...
urlpatterns = [
    ...
    path(
        "generic-delete",
        views.KiteDeleteConfirmationView.as_view(),
        name="generic-delete",
    ),
    path(
        "kite-history-revert/<int:pk>/<int:history_id>/",
        history.KiteHistoryView.as_view(),
        name="history-revert",
    ),
]
