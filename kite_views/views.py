...
from kite.signals import post_generic_delete, pre_generic_delete
from kite_views import models
from kite_views.cbv_methods import get_short_uuid, login_required, merge_dicts
from kite_views.forms import SavedFilterForm
from kite_views.generic.cbv.views import KiteFormView, KiteListView
...
class ReloadField(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        model: models.KiteModel = dynamic_cache["model"]
...
@method_decorator(login_required, name="dispatch")
class SavedFilter(KiteFormView):
    """
    SavedFilter
    """
...
class DynamiListView(KiteListView):
    """
...
class KiteDeleteConfirmationView(View):
    """
