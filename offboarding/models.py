...
class OffboardingStage(KiteModel):
    """
    Offboarding model
    """
...
class OffboardingStageMultipleFile(KiteModel):
    """
...
class OffboardingEmployee(KiteModel):
    """
...
class ResignationLetter(KiteModel):
    """
...
class OffboardingTask(KiteModel):
    """
...
class OffboardingNote(KiteModel):
    """
    OffboardingNote
    """
...
class OffboardingGeneralSetting(KiteModel):
    """
