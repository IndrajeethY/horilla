...
class JobPositionMultiForm(ModelForm):
    ...
    department_id = KiteMultiSelectField(
...
class RotatingWorkTypeAssignForm(ModelForm):
    ...
    employee_id = KiteMultiSelectField(
...
class AnnouncementForm(ModelForm):
    ...
    employees = KiteMultiSelectField(
        queryset=Employee.objects.all(),
        widget=KiteMultiSelectWidget(
            filter_route_name="employee-widget-filter",
            filter_class=EmployeeFilter,
    ...
    def clean(self):
        ...
        if isinstance(self.fields["employees"], KiteMultiSelectField):
...
class PenaltyAccountForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if apps.is_installed("leave") and employee:
            LeaveType = get_kite_model_class(app_label="leave", model="leavetype")
