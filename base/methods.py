...
from kite.kite_apps import NESTED_SUBORDINATE_VISIBILITY
from kite.kite_middlewares import _thread_locals
from kite.kite_settings import KITE_DATE_FORMATS, KITE_TIME_FORMATS
...
def format_export_value(value, employee):
    ...
    if isinstance(value, time):
        ...
        for format_name, format_string in KITE_TIME_FORMATS.items():
        ...
        for format_name, format_string in KITE_DATE_FORMATS.items():
