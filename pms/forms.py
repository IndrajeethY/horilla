...
from base.forms import ModelForm as KiteModelForm
...
class ObjectiveForm(BaseForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["assignees"] = KiteMultiSelectField(
        ...
        self.fields["managers"] = KiteMultiSelectField(
            queryset=Employee.objects.all(),
            widget=KiteMultiSelectWidget(
                filter_route_name="employee-widget-filter",
                filter_class=EmployeeFilter,
...
class FeedbackForm(KiteModelForm):
    """
...
class PeriodForm(KiteModelForm):
    """
...
class MeetingsForm(BaseForm):
    ...
    def as_p(self):
        ...
        """
        context = {"form": self}
        table_html = render_to_string("kite_form.html", context)
        return table_html
    ...
    def clean(self):
        ...
        if isinstance(self.fields["employee_id"], KiteMultiSelectField):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields["employee_id"] = KiteMultiSelectField(
...
class BonusPointSettingForm(KiteModelForm):
    """
...
class EmployeeBonusPointForm(KiteModelForm):
    """
...
class EmployeeFeedbackForm(KiteModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields["others_id"] = KiteMultiSelectField(
            queryset=Employee.objects.filter(employee_work_info__isnull=False),
            widget=KiteMultiSelectWidget(
                filter_route_name="employee-widget-filter",
                filter_class=EmployeeFilter,
    ...
    def clean(self):
        cleaned_data = super().clean()
        if isinstance(self.fields["others_id"], KiteMultiSelectField):
...
class BulkFeedbackForm(KiteModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields["employee_ids"] = KiteMultiSelectField(
            queryset=Employee.objects.filter(employee_work_info__isnull=False),
            widget=KiteMultiSelectWidget(
                filter_route_name="employee-widget-filter",
                filter_class=EmployeeFilter,
    ...
    def clean(self):
        cleaned_data = super().clean()
        if isinstance(self.fields["employee_ids"], KiteMultiSelectField):
