"""
kite_api/urls/attendance/urls.py
"""

from django.urls import path

from kite_api.api_views.attendance.permission_views import AttendancePermissionCheck
from kite_api.api_views.attendance.views import *
