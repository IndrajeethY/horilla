...
from base.models import KiteMailTemplate, JobPosition
...
from kite.group_by import group_by_queryset as general_group_by
...
def candidates_view(request):
    ...
    mail_templates = KiteMailTemplate.objects.all()
...
def email_send(request):
    ...
    bodys = list(
        KiteMailTemplate.objects.filter(id__in=template_attachment_ids).values_list(
            "body", flat=True
        )
    )
