...
class OnboardingStage(KiteModel):
    """
    ...
    objects = KiteCompanyManager("recruitment_id__company_id")
...
class OnboardingTask(KiteModel):
    """
    ...
    objects = KiteCompanyManager("stage_id__recruitment_id__company_id")
...
class CandidateStage(KiteModel):
    """
...
class OnboardingPortal(KiteModel):
    """
