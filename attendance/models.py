...
class AttendanceActivity(KiteModel):
    """
...
class BatchAttendance(KiteModel):
    """
...
class AttendanceRequestFile(KiteModel):
    file = models.FileField(upload_to=upload_path)


class AttendanceRequestComment(KiteModel):
    """
...
class AttendanceOverTime(KiteModel):
    """
...
class AttendanceLateComeEarlyOut(KiteModel):
    """
...
class AttendanceValidationCondition(KiteModel):
    """
...
class AttendanceGeneralSetting(KiteModel):
    """
