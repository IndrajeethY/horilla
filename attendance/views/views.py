...
from kite.kite_settings import DYNAMIC_URL_PATTERNS, KITE_DATE_FORMATS
from kite.methods import remove_dynamic_url
...
def work_record_export(request):
    ...
    format_string = KITE_DATE_FORMATS.get(date_format)
