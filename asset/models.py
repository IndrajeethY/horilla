...
class Asset(KiteModel):
    ...
    objects = KiteCompanyManager("asset_category_id__company_id")
...
class AssetDocuments(KiteModel):
    """
...
class AssetAssignment(KiteModel):
    """
    ...
    objects = KiteCompanyManager("asset_id__asset_lot_number_id__company_id")
