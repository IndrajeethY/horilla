...
from kite.settings import MIDDLEWARE

MIDDLEWARE.append("base.middleware.CompanyMiddleware")
MIDDLEWARE.append("kite.kite_middlewares.MethodNotAllowedMiddleware")
MIDDLEWARE.append("kite.kite_middlewares.ThreadLocalMiddleware")
MIDDLEWARE.append("kite.kite_middlewares.SVGSecurityMiddleware")
