...
This module is used to register kite addons
"""

from kite import settings
from kite.settings import INSTALLED_APPS

INSTALLED_APPS.append("accessibility")
INSTALLED_APPS.append("kite_audit")
INSTALLED_APPS.append("kite_widgets")
INSTALLED_APPS.append("kite_crumbs")
INSTALLED_APPS.append("kite_documents")
INSTALLED_APPS.append("kite_views")
INSTALLED_APPS.append("kite_automations")
INSTALLED_APPS.append("auditlog")
INSTALLED_APPS.append("biometric")
INSTALLED_APPS.append("helpdesk")
INSTALLED_APPS.append("offboarding")
INSTALLED_APPS.append("kite_backup")
