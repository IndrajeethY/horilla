...
class HorillaAutomationConfig(AppConfig):
    ...
    def ready(self) -> None:
        ...
        try:
            ...
            from base.templatetags.kitefilters import app_installed
            from employee.models import Employee
            from kite_automations.methods.methods import get_related_models
            from kite_automations.models import MODEL_CHOICES
            ...
            try:
                from kite_automations.signals import start_automation
