...
class AllowanceForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["specific_employees"] = KiteMultiSelectField(
...
class ReimbursementForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.request = getattr(kite_middlewares._thread_locals, "request", None)
    ...
    def setup_leave_fields(self):
        ...
        AvailableLeave = get_kite_model_class(
        ...
        if type_ == "bonus_encashment":
            ...
            if not leave_type:
                ...
                if leave_type not in encashable:
                    ...
                    AvailableLeave = get_kite_model_class("leave", "availableleave")
