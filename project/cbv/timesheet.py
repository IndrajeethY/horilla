...
from kite_views.cbv_methods import login_required
from kite_views.generic.cbv.views import (
    KiteCardView,
    KiteDetailedView,
    KiteFormView,
    KiteListView,
...
class TimeSheetNavView(KiteNavView):
    """
    Nav bar
    """
...
class TimeSheetList(KiteListView):
    """
...
class TaskTimeSheet(TimeSheetList):
    ...
    def get_queryset(self):
        queryset = KiteListView.get_queryset(self)
        task_id = self.kwargs.get("task_id")
...
class TimeSheetFormView(KiteFormView):
    """
...
class TimeSheetCardView(KiteCardView):
    """
    For card view
    """
...
class TimeSheetDetailView(KiteDetailedView):
    """
