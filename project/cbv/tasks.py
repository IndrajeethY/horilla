...
@method_decorator(login_required, name="dispatch")
class TaskListView(KiteListView):
    """
...
@method_decorator(login_required, name="dispatch")
class TaskCreateForm(KiteFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class TaskDetailView(KiteDetailedView):
    """
...
@method_decorator(login_required, name="dispatch")
class TaskCardView(KiteCardView):
    """
