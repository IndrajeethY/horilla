...
class ProjectStage(KiteModel):
    ...
    objects = KiteCompanyManager("project__company_id")
...
class TimeSheet(KiteModel):
    ...
    objects = KiteCompanyManager("project_id__company_id")
