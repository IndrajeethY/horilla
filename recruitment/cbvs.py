...
class LinkedinSettingSectionView(views.KiteSectionView):
    """
...
class LinkedInSettingNavView(views.KiteNavView):
    """
...
class LinkedInAccountFormView(views.KiteFormView):
    """
    LinkedInForm View
    """
...
class LinkedInSettingListView(views.KiteListView):
    """
