...
from kite_audit.methods import get_diff
...
class SurveyTemplate(KiteModel):
    """
    ...
    objects = KiteCompanyManager("company_id")
...
class Stage(KiteModel):
    ...
    objects = KiteCompanyManager(related_company_field="recruitment_id__company_id")
...
class RejectedCandidate(KiteModel):
    """
    RejectedCandidate
    """
...
class RecruitmentSurvey(KiteModel):
    """
    ...
    objects = KiteCompanyManager(related_company_field="recruitment_ids__company_id")
...
class QuestionOrdering(KiteModel):
    """
...
class RecruitmentSurveyAnswer(KiteModel):
    """
...
class SkillZoneCandidate(KiteModel):
    """
...
class CandidateRating(KiteModel):
...
class RecruitmentGeneralSetting(KiteModel):
    """
...
class InterviewSchedule(KiteModel):
    """
    ...
    objects = KiteCompanyManager("candidate_id__recruitment_id__company_id")
...
class CandidateDocumentRequest(KiteModel):
    title = models.CharField(max_length=100)
...
class CandidateDocument(KiteModel):
...
class LinkedInAccount(KiteModel):
