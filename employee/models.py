...
from kite.models import KiteModel, has_xss, upload_path
...
class Employee(models.Model):
    ...
    def get_archive_condition(self):
        ...
        if apps.is_installed("onboarding"):
            OnboardingStage = get_kite_model_class("onboarding", "onboardingstage")
            OnboardingTask = get_kite_model_class("onboarding", "onboardingtask")
        ...
        if apps.is_installed("recruitment"):
            Recruitment = get_kite_model_class("recruitment", "recruitment")
            Stage = get_kite_model_class("recruitment", "stage")
    ...
    def check_online(self):
        ...
        """
        if apps.is_installed("attendance"):
            Attendance = get_kite_model_class("attendance", "attendance")
...
class EmployeeBankDetails(KiteModel):
    """
...
class PolicyMultipleFile(KiteModel):
    """
...
class DisciplinaryAction(KiteModel):
    """
    Disciplinary model
    """
...
class EmployeeGeneralSetting(KiteModel):
    """
...
class ProfileEditFeature(KiteModel):
    """
    ProfileEditFeature
    """
