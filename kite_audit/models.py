...
from kite_audit.methods import remove_duplicate_history
...
class KiteAuditInfo(models.Model):
    """
    KiteAuditInfo model to store additional info
    """
...
class KiteAuditLog(HistoricalRecords):
    """
...
def post_create_kite_audit_log(sender, instance, *_args, **kwargs):
    ...
    try:
        ...
        if isinstance(history_instance, KiteAuditLog):
